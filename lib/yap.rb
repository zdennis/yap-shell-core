...
module Yap
  ...
  def self.run_shell
    addons = []
    addons.push WorldAddons.load_addons_from_files(dir:"#{ENV['HOME']}", files:Dir["#{ENV['HOME']}/.yaprc"])
    addons.push WorldAddons.load_addons_from_files(dir:"#{ENV['HOME']}/.yap-addons/", files:Dir["#{ENV['HOME']}/.yap-addons/**/*.rb"])
